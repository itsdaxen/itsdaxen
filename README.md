...
I care about _owning_ the code — what runs, why, and where the bytes go. While software is often generated fast and understood slowly, I'm betting on real engineering understanding, deliberate design, and software that holds up under pressure.

🌐 **[thedaxen.com](https://thedaxen.com)**
...
My current Qt project is **[WardView](https://github.com/itsdaxen/WardView)**, a responsive interface concept for a bedside patient monitor.
...
| ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**IPython**](https://github.com/ipython/ipython) | [![Stars](https://img.shields.io/github/stars/ipython/ipython?style=flat-square&logo=github&label=stars)](https://github.com/ipython/ipython/stargazers) | [![PR #15348](https://img.shields.io/badge/PR%20%2315348-merged-8250DF?style=flat-square&logo=github)](https://github.com/ipython/ipython/pull/15348) Restored pathlib.Path support in IFrame while preserving HTML escaping, with regression coverage. |
| [**Qt Advanced Docking System**](https://github.com/githubuser0xFFFF/Qt-Advanced-Docking-System) | [![Stars](https://img.shields.io/github/stars/githubuser0xFFFF/Qt-Advanced-Docking-System?style=flat-square&logo=github&label=stars)](https://github.com/githubuser0xFFFF/Qt-Advanced-Docking-System/stargazers) | [![PR #862](https://img.shields.io/badge/PR%20%23862-merged-8250DF?style=flat-square&logo=github)](https://github.com/githubuser0xFFFF/Qt-Advanced-Docking-System/pull/862) Made restored layouts retain the globally focused dock widget by persisting and reapplying its focus state. |
...
- Website: [thedaxen.com](https://thedaxen.com)
- Email: [farzam.sadegh@gmail.com](mailto:farzam.sadegh@gmail.com)
